...
with col_left:
    ...
    if uploaded_file:
        ...
        # Save to temp file for OpenCV reading
...
with col_right:
    ...
    if st.session_state.gif_bytes is not None:
        ...
        # Base64 embed over checkerboard container
        b64_gif = base64.b64encode(st.session_state.gif_bytes).decode("utf-8")
        st.markdown(f"""
        <div class="checkerboard-box">
            <img src="data:image/gif;base64,{b64_gif}" style="max-width: 100%; max-height: 320px; object-fit: contain; image-rendering: auto;" alt="Transparent Character Preview" />
        </div>
        """, unsafe_allow_html=True)
