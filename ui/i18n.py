...
MESSAGES = {
    "pt_BR": {
        ...
        "step_1_title": "1. Carregar Vídeo ou Sprite Sheet",
        "input_mode_label": "Tipo de Mídia de Entrada",
        "input_mode_video": "🎬 Vídeo / GIF Animado",
        "input_mode_sheet": "👾 Sprite Sheet (.PNG)",
        "upload_label": "Envie o vídeo ou GIF do personagem (MP4, WebM, MOV, AVI, GIF)",
        "upload_sheet_label": "Envie a imagem Sprite Sheet com fundo transparente ou sólido (PNG, WebP)",
        "upload_help": "Envie clipes curtos de ações de personagens, ataques, animações paradas ou de caminhada.",
        "upload_sheet_help": "Envie a folha de sprites baixada ou criada contendo a sequência de animação.",
        "video_caption": "ℹ️ Original: {width}x{height} | {duration:.2f}s | {fps:.1f} FPS",
        "sheet_caption": "ℹ️ Sprite Sheet: {width}x{height} px | Canal Alfa: {alpha}",
        "sheet_layout_label": "Disposição dos Quadros no Sprite Sheet",
        "sheet_layout_horizontal": "➡️ Faixa Horizontal (1 Linha)",
        "sheet_layout_grid": "🔲 Grade Personalizada (Colunas × Linhas)",
        "sheet_frames_count_label": "Quantidade Total de Quadros",
        "sheet_cols_label": "Número de Colunas",
        "sheet_rows_label": "Número de Linhas",
        "sheet_frame_calc": "📐 Resolução calculada de cada quadro: {w} × {h} px ({count} quadros)",
        "sheet_ai_bg_label": "Aplicar IA de Remoção de Fundo no Sprite Sheet",
        "sheet_ai_bg_help": "Marque se o seu Sprite Sheet possui fundo de cor sólida (verde/branco/preto). Deixe desmarcado se já for transparente.",
        "process_sheet_button": "⚡ Fatiar Sprite Sheet e Criar GIF Transparente",
...
""",
    ...
    "en_US": {
        ...
        "step_1_title": "1. Ingest Video or Sprite Sheet",
        "input_mode_label": "Input Media Type",
        "input_mode_video": "🎬 Video / Animated GIF",
        "input_mode_sheet": "👾 Sprite Sheet (.PNG)",
        "upload_label": "Upload character video or GIF (MP4, WebM, MOV, AVI, GIF)",
        "upload_sheet_label": "Upload Sprite Sheet image with transparent or solid background (PNG, WebP)",
        "upload_help": "Upload short clips of character actions, attacks, idle or walk animations.",
        "upload_sheet_help": "Upload downloaded or existing sprite sheet containing animation sequence.",
        "video_caption": "ℹ️ Original: {width}x{height} | {duration:.2f}s | {fps:.1f} FPS",
        "sheet_caption": "ℹ️ Sprite Sheet: {width}x{height} px | Alpha Channel: {alpha}",
        "sheet_layout_label": "Sprite Sheet Frame Layout",
        "sheet_layout_horizontal": "➡️ Horizontal Strip (1 Row)",
        "sheet_layout_grid": "🔲 Custom Grid (Columns × Rows)",
        "sheet_frames_count_label": "Total Number of Frames",
        "sheet_cols_label": "Columns Count",
        "sheet_rows_label": "Rows Count",
        "sheet_frame_calc": "📐 Calculated frame resolution: {w} × {h} px ({count} frames)",
        "sheet_ai_bg_label": "Apply AI Background Removal on Sprite Sheet",
        "sheet_ai_bg_help": "Check if your Sprite Sheet has a solid color backdrop. Uncheck if it's already transparent.",
        "process_sheet_button": "⚡ Slice Sprite Sheet & Create Transparent GIF",
